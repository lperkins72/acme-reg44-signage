...
This folder is the region-default content layer for `reg44`.
...
- `regions/reg44/data/primary-assets.json`
- `regions/reg44/data/primary.json`
- `regions/reg44/data/footer.json`
- `regions/reg44/data/primaryending.json`
- `regions/reg44/assets/primary/manifest.json`
- `regions/reg44/assets/footer/manifest.json`
...
Use this folder for region-wide defaults that should affect `reg44`.
